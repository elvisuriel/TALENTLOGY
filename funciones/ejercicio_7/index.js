...
console.log("El maximo es: " +(max(number1, number2, number3)));
document.write("El maximo es: " +(max(number1, number2, number3)));
...
document.write ("El minimo es: " + (minima(number1, number2, number3)));
console.log("El minimo es: " + (minima(number1, number2, number3)));